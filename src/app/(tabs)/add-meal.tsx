...
export default function addmealsScreen() {
    ...
    const handleAddMeal = async() => {
      if (!name || !calories || Number.isNaN(Number(calories))) {
            Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
            Alert.alert('حدث خطأ', 'أضف اسم وسعرات الوجبة');
            return;
        }
    ...
    return (
       <View style ={globalStyles.container}>
        <Text style= {globalStyles.title}> أضف وجبة</Text>
  ...
  <TextInput
        ...
        <TouchableOpacity  style = {styles.button} onPress={handleAddMeal} >
            <Text style = {styles.buttonText}>أضف الوجبة</Text>
        </TouchableOpacity>
